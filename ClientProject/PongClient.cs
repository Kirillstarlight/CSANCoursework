...
namespace PongGame
{
    ...
    class PongClient : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            // Load the messages
            _establishingConnectionMsg = Content.Load<Texture2D>("establishing-connection-msg.xpb");
            _waitingForGameStartMsg = Content.Load<Texture2D>("waiting-for-game-start-msg.xpb");
            _gamveOverMsg = Content.Load<Texture2D>("game-over-msg.xpb");
